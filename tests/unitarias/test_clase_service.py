...
from services.clase_service import (
    crear_clase_service, obtener_clases_service, obtener_clase_id_service,
    actualizar_clase_service, eliminar_clase_service
)
...
def test_actualizar_clase_service(db, profesor_test):
    ...
    clase_actualizada = actualizar_clase_service(session, nueva_clase.id, actualizar_data)
