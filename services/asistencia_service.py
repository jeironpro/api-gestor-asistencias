...
def obtener_asistencias_service(db: Session, skip: int = 0, limit: int = 100) -> list[Asistencia]:
    """
...
def obtener_asistencia_service(db: Session, id_clase: Optional[str] = None, id_usuario: Optional[str] = None,skip: int = 0, limit: int = 100) -> list[Asistencia]:
    """
...
def actualizar_asistencia_service(db: Session, id_asistencia: str, asistencia_data: CrearAsistencia) -> Asistencia:
    """
