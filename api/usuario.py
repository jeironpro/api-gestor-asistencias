...
from schemas.usuario import RolUsuario, CrearUsuario, ActualizarUsuario, RespuestaUsuario, Token
...
def lista_usuarios(skip: int = 0, limit: int = 100, db: Session = Depends(obtener_db), admin: Usuario = Depends(requerir_rol(RolUsuario.admin))):
