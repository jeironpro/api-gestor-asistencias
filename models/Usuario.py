...
class Usuario(SQLModel, table=True):
    ...
    apellido: str = Field(max_length=60, nullable=False, description="Apellido del usuario")
    correoElectronico: str = Field(max_length=100, unique=True, index=True, nullable=False, description="Correo electrónico del usuario")
    ...
    fechaRegistro: datetime = Field(default_factory=madrid_utc, description="Fecha de registro del usuario")
