...
class Asistencia(SQLModel, table=True):
    ...
    fecha: datetime = Field(default_factory=madrid_utc, description="Fecha de la asistencia")
    estado: EstadoAsistencia = Field(nullable=False, description="Estado de la asistencia")
